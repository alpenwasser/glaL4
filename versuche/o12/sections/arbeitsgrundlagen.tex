...
\begin{figure}[h!t]
    \centering
    \resizebox{0.6\textwidth}{!}{\input{images/heterodyning.pgf}}
    \caption{%
...
\begin{figure}[h!t]
    \centering
    \resizebox{0.8\textwidth}{!}{\input{images/heterodyning2.pgf}}
    \caption{%
...
\begin{figure}[h!t]
    \centering
    \resizebox{0.8\textwidth}{!}{\input{images/turbProfile.pgf}}
    \caption{%
