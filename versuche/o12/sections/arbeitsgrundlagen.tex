...
\footnotetext[1]{%
    Man  beachte, dass  beide Signale  die  gleiche Amplitude  haben, was  die
    Umformung etwas vereinfacht.
}
...
\begin{figure}[h!t]
    \centering
    \resizebox{0.75\textwidth}{!}{\input{images/heterodyning.pgf}}
    \caption{%
...
\begin{figure}[h!t]
    \centering
    \resizebox{0.95\textwidth}{!}{\input{images/heterodyning2.pgf}}
    \caption{%
...
\begin{figure}[h!t]
    \centering
    \resizebox{0.6\textwidth}{!}{\input{images/turbProfile.pgf}}
    \caption{%
