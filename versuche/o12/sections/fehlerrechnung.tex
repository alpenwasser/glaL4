...
\footnotetext[6]{%
    Die  Einlaufl\"ange  beim  Versuch  war  eigentlich  \SI{0.8}{\meter}  vom
    Rohranfang bis zum Kreuzungspunkt  der Laserstrahlen (\SI{1.0}{\meter} bis
    zum Rohrende),  aber die  zur Verf\"ugung stehenden  Simulationsdaten sind
    nun  einmal f\"ur  \SI{0.9}{\meter} durchgef\"uhrt  worden und  sollen als
    hinreichend genau f\"ur unsere Zwecke betrachtet werden.
}
...
\begin{conditions}
    ...
    s_{\overline{v}} & \SI{0.018346}{\centi\meter\per\second}, Fehler von $v_{\mathrm{max}}$, aus Regression \\
    s_{\overline{R}} & \SI{0.25}{\milli\meter}, Unsicherheit Durchmesser Messleitung                         \\
    v_{\mathrm{max}} & \SI{1.402}{\centi\meter\per\second}, aus Regression                                   \\
\end{conditions}
