...
\begin{minipage}[t]{\textwidth}
    ...
    \captionof{figure}{%
        Schematische  Illustration  der   Bestimmung  des  Schnittwinkels  der
        Laserstrahlen aus der Geometrie der Versuchsanordnung.
    }
    \label{fig:varphi}
\end{minipage}
...
Gemessen wurden  zwar Frequenzen,  es sollen  in den  Plots in  diesem Kapitel
...
\footnotetext[5]{%
    Wie in den Arbeitsgrundlagen ersichtlich,  variiert $k$ bei \"Anderung der
